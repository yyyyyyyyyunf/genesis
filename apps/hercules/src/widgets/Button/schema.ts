...
export const ButtonSchema = z.object({
  ...
  variant: z.enum(['solid', 'outline', 'ghost', 'link']).optional().describe('样式变体: solid(实心), outline(描边), ghost(幽灵), link(链接)').default('solid'),
  ...
  radius: z.enum(['none', 'sm', 'md', 'lg', 'full']).optional().describe('圆角: 按钮的圆角大小').default('md'),
